...
const account1 = {
  owner: 'Jay Vekariya',
  movements: [200, 50, -400, 3000, -650, -130, 70, 1300],
  interestRate: 1.2, // %
  pin: 1111,
};

  const account2 = {
    owner: 'Kartik Vaghsiya',
...
//function for diplay account statastics
...
//console.log('shiroya priyank maheshbhai');
...
btnTransfer.addEventListener('click',function(e){
  ...
  inputTransferAmount.value = inputTransferTo.value = ' ';
   ...
   if(
    amount>0 &&
    receiverAcc && currentAcount.balance >= amount && 
...
btnLoan.addEventListener('click',function(e){
  ...
  if(amount>0 && currentAcount.movements.some(mov=> 
    mov >= amount*0.1 )){
      //add movements
